...
public abstract class AbstractCommand extends net.minecraft.command.CommandBase {
	...
	public boolean canCommandSenderUseCommand(ICommandSender p_71519_1_, String[] params) {
		...
		else return p_71519_1_.canCommandSenderUseCommand(this.getRequiredPermissionLevel(params), this.getCommandName());
	}
	 ...
	 */
    public abstract void processCommand(ICommandSender sender, String[] params) throws net.minecraft.command.CommandException;
    ...
    public static Potion getPotion(String param) {
		...
		if (potion == null) {
			try {int i = Integer.parseInt(param); if (i >= 0 && i < Potion.potionTypes.length) potion = Potion.potionTypes[i];}
    ...
    public static EntityPlayerMP getPlayer(String param) {
    	return MinecraftServer.getServer().getConfigurationManager().getPlayerByUsername(param);
    }
