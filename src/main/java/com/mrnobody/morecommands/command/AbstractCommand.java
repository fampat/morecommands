...
import com.mrnobody.morecommands.wrapper.CommandSender.EntityCommandSenderWrapper;
...
public abstract class AbstractCommand extends net.minecraft.command.CommandBase {
     ...
     */
    public static NBTBase getNBTFromParam(String param, ICommandSender sender) {
    	if (isNBTParam(param)) {
    		NBTBase nbt = null;
