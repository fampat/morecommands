...
public class CommandPlayeruuid extends StandardCommand implements ClientCommandProperties {
	...
	public String execute(CommandSender sender, String[] params) throws CommandException {
		sender.sendLangfileMessage("command.playeruuid.uuid", Minecraft.getMinecraft().getSession().func_148256_e().getId().toString());
		return Minecraft.getMinecraft().getSession().func_148256_e().getId().toString();
	}
