...
public class CommandThru extends StandardCommand implements ServerCommandProperties {
	...
	public String execute(CommandSender sender, String[] params) throws CommandException {
		...
		Vec3 posVec = new Vec3(entity.posX, entity.posY, entity.posZ);
    	...
    	for (int step = 1; step < distance; step++) {
    		if (WorldUtils.canStand(entity.worldObj, new BlockPos(trace.getBlockPos().getX() + stepX * step, trace.getBlockPos().getY(), trace.getBlockPos().getZ() + stepZ * step))) {
