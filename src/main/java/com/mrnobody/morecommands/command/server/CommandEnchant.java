    		...
    		if(params[0].equals("list")) {
    			...
    			if (validParam) {
    				...
    				for (int index = from; index < to; index++) {
    					if (Enchantment.enchantmentsBookList[index] != null) sender.sendStringMessageToPlayer(" - '" + Enchantment.enchantmentsBookList[index].getName().substring(12) + "' (" + String.valueOf(Enchantment.enchantmentsBookList[index].effectId) + ")");
    				}
