	...
	public void execute(final CommandSender sender, String[] params) throws CommandException {
		...
		for (final Entity entity : entities)
			MinecraftServer.getServer().getCommandManager().executeCommand(new ICommandSender() {
				...
				public boolean sendCommandFeedback() {MinecraftServer minecraftserver = MinecraftServer.getServer(); return minecraftserver == null || minecraftserver.worldServers[0].getGameRules().getBoolean("commandBlockOutput");}
