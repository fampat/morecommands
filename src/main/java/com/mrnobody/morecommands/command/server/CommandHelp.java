	...
	public void execute(CommandSender sender, String[] params) throws CommandException {
		...
		if (show.equals("generalhelp")) {
			...
			if (commands.get(params[0]) instanceof ServerCommand && commands.get(params[0]).getClass().getAnnotation(Command.class) != null) {
				...
				sender.sendChatComponentToPlayer(this.MESSAGE_NAME.appendSibling((new ChatComponentText(command.getCommandName())).setChatStyle((new ChatStyle()).setColor(EnumChatFormatting.WHITE))));
