		...
		if (params.length > 1) {
			try {
				...
				if (params[1].toUpperCase().startsWith("N")) {
					EntityUtils.setPosition(entity, new Coordinate(entity.posX, entity.posY, entity.posZ - distance));
				} else if (params[1].toUpperCase().startsWith("E")) {
					EntityUtils.setPosition(entity, new Coordinate(entity.posX + distance, entity.posY, entity.posZ));
					...
					EntityUtils.setPosition(entity, new Coordinate(entity.posX, entity.posY + distance, entity.posZ));
