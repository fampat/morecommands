...
public class CommandOp extends StandardCommand implements ServerCommandProperties {
	...
	public String execute(CommandSender sender, String[] params) throws CommandException {
		if (params.length > 0) {
            ...
            server.getConfigurationManager().getOppedPlayers().addEntry(new UserListOpsEntry(profile, permLevel, server.getConfigurationManager().getOppedPlayers().func_183026_b(profile)));
