	                    ...
	                    if (flag5)
	                    {
	                        ...
	                        if (target instanceof EntityLivingBase)
	                        {
	                            ...
	                            if (player.world instanceof WorldServer && f4 > 2.0F)
	                            {
	                                ...
	                                ((WorldServer)player.world).spawnParticle(EnumParticleTypes.DAMAGE_INDICATOR, target.posX, target.posY + (double)(target.height * 0.5F), target.posZ, k, 0.1D, 0.0D, 0.1D, 0.2D, new int[0]);
	                            }
	                        }
