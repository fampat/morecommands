...
import com.mrnobody.morecommands.patch.PatchManager.ForgeEventBasedPatch;
import com.mrnobody.morecommands.patch.PatchManager.StateEventBasedPatch;
...
public final class PatchManager {
	 ...
	 * @author MrNobody98
	 */
	public static class AppliedPatches implements IExtendedEntityProperties {
		public static final String PATCHES_IDENTIFIER = "morecommands_patches";
		...
		private Map<String, Boolean> appliedPatches = Maps.newConcurrentMap();
	...
	public AppliedPatches getAppliedPatchesForPlayer(EntityPlayerMP player) {
		AppliedPatches patches = MoreCommands.getEntityProperties(AppliedPatches.class, AppliedPatches.PATCHES_IDENTIFIER, player);
		
		if (patches == null) 
			player.registerExtendedProperties(AppliedPatches.PATCHES_IDENTIFIER, patches = new AppliedPatches());
