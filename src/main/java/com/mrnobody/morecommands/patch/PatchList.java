...
public final class PatchList {
	...
	/** The patch to the EntityPlayerSP class. See {@link PatchEntityClientPlayerMP} */
	public static final String PATCH_ENTITYCLIENTPLAYERMP = "PATCH_ENTITYCLIENTPLAYERMP";
	...
	public static void registerPatches() {
		...
		if (MoreCommands.isClientSide()) {
			...
			PatchManager.instance().registerPatch(new PatchEntityClientPlayerMP(PATCH_ENTITYCLIENTPLAYERMP));
		}
