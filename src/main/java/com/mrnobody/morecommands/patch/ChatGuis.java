...
public final class ChatGuis {
	...
	public static final class GuiChat extends net.minecraft.client.gui.GuiChat {
		...
		@Override
		public void func_146403_a(String chat) {
			processChat(this.mc, chat);
		}
	}
	 ...
	 */
	private static void processChat(Minecraft mc, String chat) {
		mc.ingameGUI.getChatGUI().addToSentMessages(chat);
