...
public class PatchEntityPlayerSP implements PatchManager.StateEventBasedPatch, PatchManager.ForgeEventBasedPatch {
	...
	public <T extends Event> boolean needsToBeApplied(T e) {
		...
		return event.getGui() instanceof net.minecraft.client.gui.GuiMultiplayer || (event.getGui() instanceof GuiMainMenu && this.startupServerName != null);
	}
	    	...
	    	new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
	    		...
	    		public void run() {
	    			...
	    			try {
	    				...
	    				GuiConnecting.this.networkManager.sendPacket(new C00Handshake(315, ip, port, EnumConnectionState.LOGIN, true));
	...
	public static class EntityPlayerSP extends net.minecraft.client.entity.EntityPlayerSP implements ResultAcceptingCommandSender {
	    ...
	    public StatisticsManager getStatWriter() {
