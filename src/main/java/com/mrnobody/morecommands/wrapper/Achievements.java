...
public class Achievements
{
	...
	public static Achievement getAchievementByName(String name) {
		return achievements.containsKey(name) ? achievements.get(name) : null;
	}
	...
	public static String getAchievementRequirement(String name) {
		return achievements.containsKey(name) ? achievements.containsValue(name) ? achievements.inverse().get(achievements.get(name).parentAchievement) : null: null;
	}
