...
public class EventHandler<T extends Event> {
	...
	public static final ForgeEventHandler<TickEvent>                   TICK = new ForgeEventHandler<TickEvent>(FMLCommonHandler.instance().bus(), TickEvent.class, false);
	...
	public static final ForgeEventHandler<KeyInputEvent>               KEYINPUT = new ForgeEventHandler<KeyInputEvent>(FMLCommonHandler.instance().bus(), KeyInputEvent.class, true);
	...
	public static final ForgeEventHandler<PlaySoundEvent17>            SOUND = new ForgeEventHandler<PlaySoundEvent17>(MinecraftForge.EVENT_BUS, PlaySoundEvent17.class, true);
	 ...
	 * (retrievable via {@link cpw.mods.fml.common.Loader#activeModContainer()} or {@link cpw.mods.fml.common.Loader#getReversedModObjectList()})
	 ...
	 * @author MrNobody98
	 */
	public static class ForgeEventHandler<T extends Event> extends EventHandler<T> {
		...
		/**
		 * Registers a handler to its {@link cpw.mods.fml.common.eventhandler.EventBus}. <br>
