...
public final class ServerPlayerSettings extends PlayerSettings {
	...
	public ServerPlayerSettings(EntityPlayerMP newPlayer, ServerPlayerSettings other) {
	...
	public void loadNBTData(NBTTagCompound nbt) {
		...
		NBTTagList chatChannels = nbt.getTagList(NBT_CHATCHANNELS_IDENTIFIER, NBT.TAG_STRING);
