...
public class CommonHandler {
	...
	public void clonePlayer(Clone event) {
		...
		MoreCommands.INSTANCE.getPacketDispatcher().sendS14RemoteWorld((EntityPlayerMP) event.getEntityPlayer(), event.getEntityPlayer().worldObj.getSaveHandler().getWorldDirectory().getName());
	}
