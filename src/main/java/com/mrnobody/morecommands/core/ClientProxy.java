...
public class ClientProxy extends CommonProxy {
	...
	public void registerAliases(EntityPlayer player) {
		if (player instanceof EntityPlayerSP) {
			...
			if (settings != null) this.registerClientAliases(settings);
		}
	 ...
	 */
	private void registerClientAliases(ClientPlayerSettings settings) {
	...
	public SettingsManager createSettingsManagerForPlayer(EntityPlayer player) {
		if (player instanceof EntityPlayerSP) return this.settingsManager;
			...
			if (((EntityPlayerMP) player).getName().equals(player.getServer().getServerOwner())) return this.settingsManager;
