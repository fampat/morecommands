...
public final class Xray implements Runnable, TwoEventListener<TickEvent, RenderWorldLastEvent>, EventListener<WorldEvent.Unload> {
	...
	private void drawOres(float px, float py, float pz){
		...
		for (BlockPosition b : temp){
			...
			w.setColorRGBA(b.color.getRed(), b.color.getGreen(), b.color.getBlue(), 255);
			w.setBrightness(200);
			
			w.addVertex(bx-px + f, by-py + f1, bz-pz + f); w.addVertex(bx-px + f1, by-py + f1, bz-pz + f);
			w.addVertex(bx-px + f1, by-py + f1, bz-pz + f); w.addVertex(bx-px + f1, by-py + f1, bz-pz + f1); 
			w.addVertex(bx-px + f1, by-py + f1, bz-pz + f1); w.addVertex(bx-px + f, by-py + f1, bz-pz + f1);
			w.addVertex(bx-px + f, by-py + f1, bz-pz + f1); w.addVertex(bx-px + f, by-py + f1, bz-pz + f);
	
			w.addVertex(bx-px + f1, by-py + f, bz-pz + f); w.addVertex(bx-px + f1, by-py + f, bz-pz + f1);
			w.addVertex(bx-px + f1, by-py + f, bz-pz + f1); w.addVertex(bx-px + f, by-py + f, bz-pz + f1);
			w.addVertex(bx-px + f, by-py + f, bz-pz + f1); w.addVertex(bx-px + f, by-py + f, bz-pz + f);
			w.addVertex(bx-px + f, by-py + f, bz-pz + f); w.addVertex(bx-px + f1, by-py + f, bz-pz + f);
			
			w.addVertex(bx-px + f1, by-py + f, bz-pz + f1); w.addVertex(bx-px + f1, by-py + f1, bz-pz + f1);
			w.addVertex(bx-px + f1, by-py + f, bz-pz + f); w.addVertex(bx-px + f1, by-py + f1, bz-pz + f);
			w.addVertex(bx-px + f, by-py + f, bz-pz + f1); w.addVertex(bx-px + f, by-py + f1, bz-pz + f1);
			w.addVertex(bx-px + f, by-py + f, bz-pz + f); w.addVertex(bx-px + f, by-py + f1, bz-pz + f);
