...
public final class Xray implements Runnable, TwoEventListener<TickEvent, RenderWorldLastEvent>, EventListener<WorldEvent.Unload> {
	...
	private void drawOres(float px, float py, float pz){
		...
		for (BlockPosition b : temp){
			...
			buf.pos(bx-px + f, by-py + f1, bz-pz + f).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f1, by-py + f1, bz-pz + f).color(red, green, blue, 255).endVertex();
			buf.pos(bx-px + f1, by-py + f1, bz-pz + f).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f1, by-py + f1, bz-pz + f1).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f1, by-py + f1, bz-pz + f1).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f, by-py + f1, bz-pz + f1).color(red, green, blue, 255).endVertex();
			buf.pos(bx-px + f, by-py + f1, bz-pz + f1).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f, by-py + f1, bz-pz + f).color(red, green, blue, 255).endVertex();
	
			buf.pos(bx-px + f1, by-py + f, bz-pz + f).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f1, by-py + f, bz-pz + f1).color(red, green, blue, 255).endVertex();
			buf.pos(bx-px + f1, by-py + f, bz-pz + f1).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f, by-py + f, bz-pz + f1).color(red, green, blue, 255).endVertex();
			buf.pos(bx-px + f, by-py + f, bz-pz + f1).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f, by-py + f, bz-pz + f).color(red, green, blue, 255).endVertex();
			buf.pos(bx-px + f, by-py + f, bz-pz + f).color(red, green, blue, 255).endVertex(); 
			buf.pos(bx-px + f1, by-py + f, bz-pz + f).color(red, green, blue, 255).endVertex();
