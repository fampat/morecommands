...
public final class GlobalSettings implements EventListener<WorldEvent.Load> {
	...
	public void onEvent(WorldEvent.Load event) {
		...
		put(aliases, this.manager.getMappedSettings("aliases", null, MinecraftServer.getServer().getFolderName(), event.world.provider.getDimensionName(), String.class));
		put(variables, this.manager.getMappedSettings("variables", null, MinecraftServer.getServer().getFolderName(), event.world.provider.getDimensionName(), String.class));
	 ...
	 */
	private static void registerGlobalAliases() {
