...
public final class DummyCommand implements ICommand {
	...
	public final int compareTo(ICommand o) {return -1;}
	public final String getCommandUsage(ICommandSender p_71518_1_) {return "";}
	public final void processCommand(ICommandSender sender, String[] msg) throws CommandException {throw new CommandNotFoundException();}
