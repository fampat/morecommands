 ...
 * @author MrNobody98
 */
public class PlayerSettings implements IExtendedEntityProperties {
	...
	public final void init(Entity entity, World world) {
		if (entity instanceof EntityPlayerMP) 
			MoreCommands.getProxy().updateWorld((EntityPlayerMP) entity);
	}
	
	@Override public final void saveNBTData(NBTTagCompound compound) {}
	@Override public final void loadNBTData(NBTTagCompound compound) {}
