...
public final class ObfuscatedNames {
	...
	public static final class ObfuscatedMethod<O, R> {
		...
		public static final ObfuscatedMethod<EntityDragon, Void> EntityDragon_func_175499_a = new ObfuscatedMethod
				<EntityDragon, Void>("func_175499_a", "func_175499_a", EntityDragon.class, void.class, BlockPos.class);
