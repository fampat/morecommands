...
public final class EntityUtils {
	private EntityUtils() {}
	private static final Field foodLevel = ReflectionHelper.getField(ObfuscatedField.FoodStats_foodLevel);
	 ...
	 */
	public static boolean spawnEntity(String entity, boolean ignoreCase, Coordinate location, World world, NBTTagCompound compound, boolean mergeLists) {
	 ...
	 * @return whether spawning the entity was successful
	 */
	public static boolean spawnEntity(Class<? extends Entity> entityClass, Coordinate location, World world, NBTTagCompound compound, boolean mergeLists) {
		try {
			if (entityClass != null) {
				Entity entityInstance = (Entity)entityClass.getConstructor(net.minecraft.world.World.class).newInstance(world);
	...
	public static List<Entity> killEntities(String entity, boolean ignoreCase, Coordinate location, World world, double distance) {
	 ...
	 */
	public static List<Entity> killEntities(Class<? extends Entity> entityClass, Coordinate location, World world, double distance) {
	...
	public static List<Entity> findEntities(String entity, boolean ignoreCase, Coordinate location, World world, double distance) {
	 ...
	 */
	public static List<Entity> findEntities(Class<? extends Entity> entityClass, Coordinate location, World world, double distance) {
	 ...
	 */
	public static void setPosition(Entity entity, Coordinate c) {
		if (entity instanceof EntityLivingBase)
			((EntityLivingBase) entity).setPositionAndUpdate(c.getX(), c.getY(), c.getZ());
		else
			entity.setLocationAndAngles(c.getX(), c.getY(), c.getZ(), entity.rotationYaw, entity.rotationPitch);
	}
	
	/**
	 * @return the entity's position
	 */
	public static Coordinate getPosition(Entity entity) {
	...
	public static void addPotionEffect(EntityLivingBase entity, int id, int duration, int strength, boolean invisible) {
		entity.addPotionEffect(new PotionEffect(id, duration, strength, invisible));
	}
	 ...
	 */
	public static Entity traceEntity(EntityLivingBase entity, double distance) {
	 ...
	 */
	public static MovingObjectPosition rayTrace(EntityLivingBase entity, double distance, double borderSize, float partialTickTime) {
	 ...
	 */
	public static Coordinate traceBlock(EntityLivingBase entity, double distance) {
	 ...
	 */
	public static MovingObjectPosition rayTraceBlock(EntityLivingBase entity, double distance, float partialTickTime) {
	 ...
	 */
	public static Vec3 getPositionVec(EntityLivingBase entity, float partialTickTime) {
	...
	public static void setHunger(EntityPlayerMP player, int food) {
		ReflectionHelper.set(ObfuscatedField.FoodStats_foodLevel, foodLevel, player.getFoodStats(), food);
	}
	...
	public static boolean hasAchievement(EntityPlayerMP player, Achievement ach) {
		return player.func_147099_x().hasAchievementUnlocked(ach);
	}
	...
	public static void removeAchievement(EntityPlayerMP player, Achievement ach) {
        player.func_147099_x().func_150873_a(player, ach, 0);
        Iterator iterator = player.getWorldScoreboard().func_96520_a(ach.func_150952_k()).iterator();

        while (iterator.hasNext()) {
            ScoreObjective scoreobjective = (ScoreObjective) iterator.next();
            player.getWorldScoreboard().func_96529_a(player.getCommandSenderName(), scoreobjective).setScorePoints(0);
        }

        if (player.func_147099_x().func_150879_e())
            player.func_147099_x().func_150876_a(player);
	}
	
	/**
	 * @return the player's spawn point
	 */
	public static Coordinate getSpawn(EntityPlayerMP player) {
		return player.getBedLocation(player.dimension) != null ? new Coordinate(player.getBedLocation(player.dimension).posX, 
		player.getBedLocation(player.dimension).posY, player.getBedLocation(player.dimension).posZ) : null;
	}
	
	/**
	 * Sets the players spawn point
	 */
	public static void setSpawn(EntityPlayerMP player, Coordinate coord) {
		player.setSpawnChunk(new ChunkCoordinates(coord.getBlockX(), coord.getBlockY(), coord.getBlockZ()), true);
	}
