...
public final class EntityUtils {
	...
	static {
		NAME_TO_CLASS_MAP = Collections.unmodifiableMap(ReflectionHelper.get(ObfuscatedField.EntityList_NAME_TO_CLASS, null));
		CLASS_TO_NAME_MAP = Collections.unmodifiableMap(ReflectionHelper.get(ObfuscatedField.EntityList_CLASS_TO_NAME, null));
		ID_TO_CLASS_MAP = Collections.unmodifiableMap(ReflectionHelper.get(ObfuscatedField.EntityList_ID_TO_CLASS, null));
		CLASS_TO_ID_MAP = Collections.unmodifiableMap(ReflectionHelper.get(ObfuscatedField.EntityList_CLASS_TO_ID, null));
		NAME_TO_ID_MAP = Collections.unmodifiableMap(ReflectionHelper.get(ObfuscatedField.EntityList_NAME_TO_ID, null));
	}
	...
	public static void removeEnchantments(EntityLivingBase entity) {
		if (entity.getHeldItemMainhand() == null) return;
	...
	public static boolean addEnchantment(EntityLivingBase entity, Enchantment enchantment, int level, boolean strict) {
		if (entity.getHeldItemMainhand() == null) return false;
	...
	public static RayTraceResult rayTrace(Entity entity, double distance, double borderSize, float partialTickTime) {
		...
		RayTraceResult blockHit = entity.worldObj.rayTraceBlocks(startVec, endVec);
